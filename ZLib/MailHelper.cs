...
namespace Z
{
    ...
    public class MailHelper
    {
        ...
        public static void sendMail(string smtpserver, string userName, string pwd, string nickName, string strfrom, ArrayList strto, string subj, string bodys, ArrayList AttachFilePaths)
        {
