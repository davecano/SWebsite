<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManage.aspx.cs" Inherits="KBsiteframe.Web.Manager.SysManage.UserManage" %>
    ...
    <form id="form1" runat="server" defaultbutton="zbquery">
        <div class="panel panel-default">
            ...
            <div class="panel-footer align-center">
                ...
                &nbsp;
                <cc1:ZButton ID="ZButton7" runat="server" Text="设定权限" OnClick="ZButton7_Click" ModuleCode="UserManage" Operate="分配权限" />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
