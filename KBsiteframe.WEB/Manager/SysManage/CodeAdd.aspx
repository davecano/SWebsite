<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeAdd.aspx.cs" Inherits="KBsiteframe.Web.Manager.SysManage.CodeAdd" %>
        ...
        <div class="page-content">
            ...
            <div class="clearfix form-actions">
                <div class="center">
                    ...
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" Text="添加" OnClientClick="return CheckForm();" OnClick="btnAdd_Click" ModuleCode="CodeManage" Operate="添加" />
                </div>
            </div>
        </div>
    </form>
