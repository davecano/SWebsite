<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdd.aspx.cs" Inherits="KBsiteframe.Web.Manager.SysManage.UserAdd" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CheckForm() {
            ...
            if ($("#lbseleted option").size() == 0) {
                layer.tips("请选择角色", $("#lbseleted"), { guide: 1, time: 3 });
                $("#lbseleted").focus();
                return false;
            }
            return ret;
        }
        function checklist(listname, selected) {
            var ret = true;
            if ($("#" + listname + " option" + selected).size() == 0) {
                layer.tips("请选择角色", $("#" + listname + ""), { guide: 1, time: 3 });
                $("#" + listname + "").focus();
                return false;
    ...
    <form id="form1" runat="server">
        <div class="page-content">
            ...
            <div class="row show-grid">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label class="col-sm-2 align-right control-label no-padding-right">所属角色</label>
					    <div class="col-sm-7">
                            <table class="table table-condensed table-bordered">
                                <thead>
                                    <tr>
                                        <th class="center">可选角色</th>
                                        <th class="center">操作</th>
                                        <th class="center">已选角色</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:ListBox ID="lbunseleted" runat="server" Height="200px" Width="100%"></asp:ListBox>
                                        </td>
                                        <td style="text-align: center; vertical-align:middle;">
                                            <cc1:ZButton ID="ZButton1" runat="server" Text="》"  OnClientClick="return checklist('lbunseleted',':selected');" OnClick="ZButton1_Click" CssClass="icon-button" />
                                            <br />
                                            <br />
                                            <cc1:ZButton ID="ZButton2" runat="server" Text="《" OnClientClick="return checklist('lbseleted',':selected');" OnClick="ZButton2_Click" CssClass="icon" /></td>
                                        <td>
                                            <asp:ListBox ID="lbseleted" runat="server" Height="200px" Width="100%"></asp:ListBox></td>
                                    </tr>
                                </tbody>
                            </table>
					    </div>
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    <input id="Return" class="btn btn-sm btn-info" type="button" value="返回" onclick="window.location.href = 'UserManage.aspx'" />
                    &nbsp;
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" Text="添加" OnClientClick="return CheckForm();" OnClick="btnAdd_Click" ModuleCode="UserManage" Operate="添加" />
                </div>
            </div>
        </div>
    </form>
