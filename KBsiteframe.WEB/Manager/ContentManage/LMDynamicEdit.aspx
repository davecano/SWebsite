<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="LMDynamicEdit.aspx.cs" Inherits="KBsiteframe.Web.Manager.ContentManage.LMDynamicEdit" %>
           ...
           <asp:HiddenField runat="server" ID="hfdynamicID"/>
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    <input id="Return" class="btn btn-sm btn-info" type="button" value="返回" onclick="window.location.href = 'LMDynamicManage.aspx'" />
                    &nbsp;
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="修改" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="LMDynamicManage" Operate="修改" />
                       &nbsp;
