<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="TDDynamicEdit.aspx.cs" Inherits="KBsiteframe.Web.Manager.ContentManage.TDDynamicEdit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page-content">
           ...
           <asp:HiddenField runat="server" ID="hfdynamicID"/>
                <div class="col-xs-12">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    <input id="Return" class="btn btn-sm btn-info" type="button" value="返回" onclick="window.location.href = 'TDDynamicManage.aspx'" />
                    &nbsp;
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="修改" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="TDDynamicManage" Operate="修改" />
                       &nbsp;
