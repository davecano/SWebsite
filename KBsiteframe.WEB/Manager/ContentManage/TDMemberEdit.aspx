<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="TDMemberEdit.aspx.cs" Inherits=" KBsiteframe.WEB.Manager.ContentManage.TDMemberEdit" %>
     ...
     <div class="col-xs-12">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    ...
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="修改" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="TDMemberManage" Operate="修改" />
                    &nbsp;
