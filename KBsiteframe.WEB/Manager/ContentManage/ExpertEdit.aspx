<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ExpertEdit.aspx.cs" Inherits=" KBsiteframe.WEB.Manager.ContentManage.ExpertEdit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page-content">
            ...
            <div class="row show-grid">
                <asp:HiddenField runat="server" ID="hfexpertid"/>
                <div class="col-xs-12">
  ...
  <div class="col-xs-12">
                    <div class="form-group">
                        <label class="col-sm-2 align-right control-label no-padding-right">置顶</label>
                        <div class="col-sm-3">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    ...
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="修改" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="ExpertManage" Operate="修改" />
                    &nbsp;
