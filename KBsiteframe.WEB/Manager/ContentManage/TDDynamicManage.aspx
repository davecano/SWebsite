<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TDDynamicManage.aspx.cs" Inherits="KBsiteframe.WEB.Manager.ContentManage.TDDynamicManage" %>
    ...
    <form id="form1" runat="server" defaultbutton="zbquery">
        <div class="panel panel-default">
            ...
            <div class="panel-footer align-center">
                <cc1:ZButton ID="zbquery" runat="server" Text="查询" ModuleCode="TDDynamicManage" OnClick="zbquery_OnClick" Operate="查询" CssClass="btn btn-sm btn-primary" />
                &nbsp;
                <cc1:ZButton ID="ZButton2" runat="server" Text="新增" ModuleCode="TDDynamicManage" OnClick="ZButton2_OnClick" Operate="添加" CssClass="btn btn-sm btn-primary" />
                        ...
                        <asp:Repeater ID="rplist" runat="server" OnItemCommand="rplist_OnItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="center">
                                        <cc1:ZLinkButton ID="zlbj" CommandName="bj" runat="server" CommandArgument='<%#Eval("DynamicID") %>' ModuleCode="TDDynamicManage" Operate="修改">修改</cc1:ZLinkButton>
                                        <cc1:ZLinkButton ID="zlsc" CommandName="sc" runat="server" CommandArgument='<%#Eval("DynamicID") %>' OnClientClick="return confirm('确定要删除吗？');" ModuleCode="TDDynamicManage" Operate="删除">删除</cc1:ZLinkButton>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
