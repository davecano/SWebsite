<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="StuMemberAdd.aspx.cs" Inherits=" KBsiteframe.WEB.Manager.ContentManage.StuMemberAdd" %>
        ...
        <div class="page-content">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    ...
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="添加" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="LMMemberManage" Operate="添加" />
                    &nbsp;
