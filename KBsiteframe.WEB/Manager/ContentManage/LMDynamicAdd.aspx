<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="LMDynamicAdd.aspx.cs" Inherits="KBsiteframe.Web.Manager.ContentManage.LMDynamicAdd" %>
        ...
        <div class="page-content">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    <input id="Return" class="btn btn-sm btn-info" type="button" value="返回" onclick="window.location.href = 'LMDynamicAddManage.aspx'" />
                    &nbsp;
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="添加" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="LMDynamicManage" Operate="添加" />
                       &nbsp;
