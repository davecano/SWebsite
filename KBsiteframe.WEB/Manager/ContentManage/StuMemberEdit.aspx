<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="StuMemberEdit.aspx.cs" Inherits=" KBsiteframe.WEB.Manager.ContentManage.StuMemberEdit" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <div class="col-xs-12">
                    <div class="form-group">
                        <label class="col-sm-1 align-right control-label no-padding-right">成员姓名</label>
                        <div class="col-sm-3">
                       <asp:TextBox runat="server" ID="txtMName"></asp:TextBox>
                        ...
                        <div class="col-sm-3">
                          <asp:TextBox runat="server" ID="txtQualification"></asp:TextBox>
                           ...
                           <label class="col-sm-1 align-right control-label no-padding-right">届</label>
                        <div class="col-sm-3">
                            <asp:DropDownList runat="server" ID="dpgrade" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-5 col-md-12">
                    <input id="Return" class="btn btn-sm btn-info" type="button" value="返回" onclick="window.location.href = 'LMMemberManage.aspx'" />
                    &nbsp;
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                    &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="修改" OnClientClick="return CheckForm();" OnClick="btnAdd_OnClick" ModuleCode="LMMemberManage" Operate="修改" />
                    &nbsp;
