<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToolAdd.aspx.cs" Inherits="KBsiteframe.WEB.Manager.ContentManage.ToolAdd" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CheckForm() {
            ...
            if ($.trim($("#txtToolName").val()) == "") {
                layer.tips("请输入工具名", $("#txtToolName"), { guide: 1, time: 3 });
                $("#txtToolName").focus();
                return false;
            }
        ...
        <%--        <div class="col-xs-12">
                ...
                <div class="clearfix form-actions">
                    ...
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                        &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" Text="添加" OnClientClick="return CheckForm();" OnClick="btnAdd_Click" ModuleCode="ToolManage" Operate="添加" />
                    </div>
                </div>
            </div>
        </div>
