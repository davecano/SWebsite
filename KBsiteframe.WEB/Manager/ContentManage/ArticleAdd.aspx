<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleAdd.aspx.cs" Inherits="KBsiteframe.WEB.Manager.ContentManage.ArticleAdd" %>
            ...
            <div class="row show-grid">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <asp:DropDownList ID="dpArticleType" runat="server"></asp:DropDownList>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="txtSummary" runat="server" TextMode="MultiLine" Width="600px" Height="100px"></asp:TextBox>
                ...
                <div class="clearfix form-actions">
                    ...
                    <input id="Reset1" class="btn btn-sm btn-warning" type="reset" value="清空" />
                        &nbsp;
                    <cc1:ZButton ID="btnAdd" runat="server" Text="添加" OnClientClick="return CheckForm();" OnClick="btnAdd_Click" ModuleCode="ArticleManage" Operate="添加" />
                    </div>
                </div>
            </div>
        </div>
