...
defaultOptions = {
	...
	legend: {
		...
		itemCheckboxStyle: {
			position: ABSOLUTE,
			width: '13px', // for IE prKBsiteframeion
			height: '13px'
		},
		// itemWidth: undefined,
		symbolWidth: 16,
	...
	getBBox: function () {
		...
		if (!bBox) {
			...
			if (renderer.isSVG) {
				...
				if (isIE && styles && styles.fontSize === '11px' && height.toPrKBsiteframeion(3) === '22.7') {
...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, forExport) {
		...
		// inside this container will be drawn at subpixel prKBsiteframeion. In order to draw
...
Highcharts.VMLElement = VMLElement = {
	...
	pathToVML: function (value) {
		...
		while (i--) {
			...
			// Multiply by 10 to allow subpixel prKBsiteframeion.
...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	path: function (path) {
		var attr = {
			// subpixel prKBsiteframeion down to 0.1 (width and height = 1px)
			coordsize: '10 10'
		};
		if (isArray(path)) {
			attr.d = path;
...
var PieSeries = {
	...
	translate: function (positions) {
		...
		var series = this,
			cumulative = 0,
			prKBsiteframeion = 1000, // issue #172
			options = series.options,
		...
		for (i = 0; i < len; i++) {
			...
			point.shapeArgs = {
				...
				start: mathRound(start * prKBsiteframeion) / prKBsiteframeion,
				end: mathRound(end * prKBsiteframeion) / prKBsiteframeion
			};
