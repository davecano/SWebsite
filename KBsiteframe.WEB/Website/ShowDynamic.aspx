<%@ Page Title="" Language="C#" MasterPageFile="~/Website/Master/KBSiteframe.Master" AutoEventWireup="true" CodeBehind="ShowDynamic.aspx.cs" Inherits="KBsiteframe.WEB.Website.ShowDynamic" %>
  ...
  <div id="list5_show_gj-content">
    ...
    <div class="list5_show_gj-biaozhu">
      <div class="list5_show_gj-biaozhu-left">
        ...
        <div class="list5_show_gj-biaozhu2">上传者：<asp:Literal runat="server" ID="ltauthor"></asp:Literal></div>
      </div>
      <!--//biaozhu-left-->
