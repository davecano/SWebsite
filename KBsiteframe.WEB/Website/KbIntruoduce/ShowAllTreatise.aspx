<%@ Page Title="" Language="C#" MasterPageFile="~/Website/Master/KBSiteframe.Master" AutoEventWireup="true" CodeBehind="ShowAllTreatise.aspx.cs" Inherits="KBsiteframe.WEB.Website.KbIntruoduce.ShowAllTreatise" %>
                    ...
                    <ItemTemplate>
                        <div class="list_text_content2_right_text_all">
                            <ul>
                                ...
                                <li><a target="_blank" href="javascript:GetID('ShowTreatise',<%#Eval("TreatiseID")%>);">•&nbsp;&nbsp;<%#Utils.CutString(Eval("TreatiseName"),37) %></a></li>
                            </ul>
                        </div>
                        <div class="list_text_content2_right_text_all_right">
                            <ul>
                                <li><%#Eval("FinishTime","{0:yyyy-MM-dd}") %></li>
