<%@ Page Title="" Language="C#" MasterPageFile="~/Website/Master/KBSiteframe.Master" AutoEventWireup="true" CodeBehind="ShowAllDynamic.aspx.cs" Inherits="KBsiteframe.WEB.Website.KbIntruoduce.ShowAllDynamic" %>
    ...
    <div id="list_text_content">
        <div class="list_text_content_middle">
            ...
            <div class="list_text_content2">
                <h3><asp:Literal runat="server" ID="lttype" ></asp:Literal></h3>
                <asp:Repeater runat="server" ID="rplist">
                    <ItemTemplate>
                        ...
                        <div class="list_text_content2_right_text_all_right">
                            <ul>
                                <li><%#Eval("SubTime","{0:yyyy-MM-dd}") %></li>
