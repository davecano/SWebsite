            ...
            <div class="list3_content1_first">
                <div class="row list3_content1_first_one">
                    ...
                    <%--    <div class="row">
                            <div class="col-sm-6">
                                <div class="list3_picture">
                                    <img width="206px" height="134px" src="../image/picture.png" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="list3_content1_first_one_left_text_shang">联盟成员:2345</div>
                                <div class="list3_content1_first_one_left_text_xia">
                                    所在机构:fsad<br />
                                    学历:<br />
                                    联系方式:safd<div>
                                        <div class="list3_chakan"><a href='ShowMember.aspx?ID=2'>【查看详细】</a></div>
                                    </div>
